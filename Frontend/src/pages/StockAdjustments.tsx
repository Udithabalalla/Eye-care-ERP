...
export default function StockAdjustments() {
  ...
  const rows = (movements?.data ?? []).filter((m) => {
    ...
    return !q || [m.product_id, m.reference_id, m.created_by].join(' ').toLowerCase().includes(q)
  })
  ...
  return (
    <div className="space-y-6">
      <section>
        ...
        <p className="text-sm text-muted-foreground">Manually correct variant stock levels with an audit trail.</p>
      </section>
      ...
      <Card className="border-border/60">
        <CardHeader>
          ...
          <CardDescription>Select a variant, set the correct stock count, and provide a reason.</CardDescription>
        </CardHeader>
          ...
          <div className="space-y-1.5">
            ...
            <Select value={reason} onValueChange={setReason}>
              ...
              <SelectContent>
                ...
                <SelectItem value="Damaged goods write-off">Damaged goods write-off</SelectItem>
                <SelectItem value="Theft / loss">Theft / loss</SelectItem>
                <SelectItem value="Supplier return">Supplier return</SelectItem>
                <SelectItem value="Opening stock entry">Opening stock entry</SelectItem>
