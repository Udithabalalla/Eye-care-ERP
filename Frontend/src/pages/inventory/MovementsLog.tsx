      ...
      <Card className="border-border/60">
        <CardHeader className="space-y-4">
          <div>
            ...
            <CardDescription>Filter by type, reference, or search by variant SKU or reference ID.</CardDescription>
          </div>
          <div className="flex flex-wrap gap-3">
            ...
            <Select value={movementType || 'all'} onValueChange={(v) => { setMovementType(v === 'all' ? '' : v); setPage(1) }}>
              <SelectTrigger className="w-44"><SelectValue placeholder="Movement type" /></SelectTrigger>
              <SelectContent>
            ...
            <Select value={referenceType || 'all'} onValueChange={(v) => { setReferenceType(v === 'all' ? '' : v); setPage(1) }}>
              <SelectTrigger className="w-52"><SelectValue placeholder="Reference type" /></SelectTrigger>
              <SelectContent>
                ...
                <Table>
                  ...
                  <TableBody>
                    ...
                    {!isLoading && rows.length === 0 && (
                      <TableRow>
                        <TableCell colSpan={6} className="h-24 text-center text-muted-foreground">No movements found.</TableCell>
                      </TableRow>
                    )}
                  </TableBody>
                </Table>
