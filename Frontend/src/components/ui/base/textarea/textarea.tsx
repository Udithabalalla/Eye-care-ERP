...
export const TextAreaBase = ({ className, ...props }: TextAreaBaseProps) => {
    return (
        <AriaTextArea
            ...
            className={(state) =>
                cx(
                    "w-full scroll-py-3 rounded-lg bg-background px-3.5 py-3 text-md text-foreground shadow-xs ring-1 ring-primary transition duration-100 ease-linear ring-inset placeholder:text-placeholder autofill:rounded-lg autofill:text-foreground focus:outline-hidden",
