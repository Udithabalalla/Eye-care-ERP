        ...
        <div className={cx("w-full in-data-input-wrapper:w-max", className)}>
            ...
            <div className="relative grid w-full items-center">
                <select
                    ...
                    className={cx(
                        "appearance-none rounded-lg bg-background px-3.5 py-2.5 text-md font-medium text-foreground shadow-xs ring-1 ring-primary outline-hidden transition duration-100 ease-linear ring-inset placeholder:text-fg-quaternary focus-visible:ring-2 focus-visible:ring-brand disabled:cursor-not-allowed disabled:bg-disabled_subtle disabled:text-disabled",
                        // Styles when the select is within an `InputGroup`
                        "in-data-input-wrapper:flex in-data-input-wrapper:h-full in-data-input-wrapper:gap-1 in-data-input-wrapper:bg-inherit in-data-input-wrapper:px-3 in-data-input-wrapper:py-2 in-data-input-wrapper:font-normal in-data-input-wrapper:text-muted-foreground in-data-input-wrapper:shadow-none in-data-input-wrapper:ring-transparent",
