...
const SelectValue = ({ isOpen, isFocused, isDisabled, size, placeholder, placeholderIcon, ref }: SelectValueProps) => {
    return (
        <AriaButton
            ref={ref}
            className={cx(
                "relative flex w-full cursor-pointer items-center rounded-lg bg-white dark:bg-gray-800 shadow-xs ring-1 ring-gray-300 dark:ring-gray-700 outline-hidden transition duration-100 ease-linear ring-inset",
