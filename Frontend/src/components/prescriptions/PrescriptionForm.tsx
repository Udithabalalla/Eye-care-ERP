      ...
      <fieldset disabled={readOnly} className="space-y-5">
        ...
        <div className="rounded-xl border border-border bg-card p-5 space-y-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-0.5">Patient, doctor, and prescription period.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <SearchableLOV
              ...
              options={patients?.data?.map((p: any): LOVOption => ({ value: p.patient_id, label: p.name, subtitle: p.patient_id })) || []}
            ...
            <div className="flex flex-col gap-1.5">
              <Label>Prescription Date <span className="text-destructive">*</span></Label>
              <Input
                type="date"
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setFormData({
                            ...
                            eye_prescription: {
                              ...formData.eye_prescription!,
                              [eye]: { ...formData.eye_prescription![eye], pupillary_distance: parseFloat(e.target.value) },
                            },
                          })
                        }
                        className="text-sm"
